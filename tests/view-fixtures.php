...
function viewFixtures(): array
{
    ...
    $route = ['company_name' => '<Ferry>', 'destination_url' => 'https://example.com/', 'route_name' => '東京〜徳島', 'departure_port' => '東京', 'arrival_port' => '徳島', 'duration' => '10時間', 'vehicle_available' => true, 'overnight' => true, 'fare_from' => '12,000', 'fare_currency' => 'JPY', 'fare_updated' => '料金確認日：2026/09/01'];
    return [
        'initial' => [false, []],
        'unknown-post' => [true, []],
